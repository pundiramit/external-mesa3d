mkdir -p prebuilt-intermediates/{glsl,ir3,main,nir,spirv,cle,isl,genxml,compiler,util,vulkan,panfrost/bifrost,panfrost/midgard}
...
python3 src/panfrost/bifrost/gen_disasm.py src/panfrost/bifrost/ISA.xml > prebuilt-intermediates/panfrost/bifrost/bifrost_gen_disasm.c
python3 src/panfrost/bifrost/bifrost_nir_algebraic.py -p src/compiler/nir/ > prebuilt-intermediates/panfrost/bifrost/bifrost_nir_algebraic.c
python3 src/panfrost/bifrost/gen_pack.py src/panfrost/bifrost/ISA.xml > prebuilt-intermediates/panfrost/bifrost/bi_generated_pack.h
python3 src/panfrost/midgard/midgard_nir_algebraic.py -p src/compiler/nir/ > prebuilt-intermediates/panfrost/midgard/midgard_nir_algebraic.c
